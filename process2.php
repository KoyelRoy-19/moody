...
// Determine result
if ($total <= 10) {
  $result = "You are not suffering from Bipolar Disorder";
  $level = "None";
} elseif ($total <= 20) {
  $result = "You are at risk of developing Bipolar Disorder";
  $level = "Mild";
} elseif ($total <= 30) {
  $result = "You are likely to have Bipolar Disorder";
  $level = "Moderate";
} else {
  $result = "You are suffering from a severe form of Bipolar Disorder";
  $level = "Severe";
}
...
<head>
    ...
    <title>Bipolar Disorder Assessment Result</title>
...
<body class="bg-gray-100 p-8 font-sans">
  <div class="max-w-xl mx-auto bg-white p-6 rounded shadow text-center">
    ...
    <a href="dashboard.php" class="mt-6 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Back to Dashboard</a>"
  </div>
</body>
</html>
