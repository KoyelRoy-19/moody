                ...
                <div class="panel border bg-white">
                    ...
                    <div class="panel-body p-3">
                        <form action="register.php" method="POST">
                            ...
                            <div><button class="btn btn-primary btn-block mt-3" type="submit">Register</button></div>
                            <div class="text-center pt-4 text-muted">Already have an account? <a href="login.php">login</a>
                            </div>
                        </form>
                    </div>
