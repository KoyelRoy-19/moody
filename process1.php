...
// Determine result
if ($total <= 10) {
  $result = "You are not suffering from Anxiety";
  $level = "None";
} elseif ($total <= 20) {
  $result = "You are at risk of developing Anxiety";
  $level = "Mild";
} elseif ($total <= 30) {
  $result = "You are likely to have Anxiety";
  $level = "Moderate";
} else {
  $result = "You are suffering from a severe form of Anxiety";
  $level = "Severe";
}
...
<head>
    ...
    <title>Anxiety Disorder Assessment Result</title>
