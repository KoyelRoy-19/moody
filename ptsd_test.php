...
<body class="bg-gray-100 p-8 font-sans">
  <div class="max-w-xl mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="process3.php" method="post" class="space-y-6">
      
      <!-- Question 1 -->
      <div>
        <p class="font-medium mb-2">1. Repeated disturbing memories of a traumatic event?</p>
      ...
      <!-- Question 2 -->
      <div>
        <p class="font-medium mb-2">2. Feeling very upset when something reminds you of the traumatic event?</p>
      ...
      <!-- Question 3 -->
      <div>
        <p class="font-medium mb-2">3. Avoiding reminders of the traumatic event?</p>
       ...
       <!-- Question 4 -->
      <div>
        <p class="font-medium mb-2">4. Avoiding places or situations that trigger anxiety?</p>
       ...
       <!-- Question 5 -->
      <div>
        <p class="font-medium mb-2">5. Trouble remembering key details of the traumatic event?</p>
        ...
        <!-- Question 6 -->
        <div>
            <p class="font-medium mb-2">6. Feeling Distant or cut off from others?</p>
        ...
        <!-- Question 7 -->
        <div>
            <p class="font-medium mb-2">7. Feeling emotionally numb?</p>
        ...
        <!-- Question 8 -->
        <div>
            <p class="font-medium mb-2">8. Feeling irritable or having angry outbursts?</p>
        ...
        <!-- Question 9 -->
        <div>
            <p class="font-medium mb-2">9. Flashbacks or intrusive thoughts about the traumatic event?</p>
        ...
        <!-- Question 10 -->
        <div>
            <p class="font-medium mb-2">10. Having difficulty sleeping?</p>
